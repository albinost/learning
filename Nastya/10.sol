...
реализовала функцию  generate() (45 строка),заполняет массив некими значениями.
Считала энергию и получилось, что при  при x=22 будет достигнут лимит по умолчанию (300trx)
